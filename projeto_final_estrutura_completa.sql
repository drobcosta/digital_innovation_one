...
INSERT INTO produto_categoria (nome) VALUES ('Eletrodomésticos') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Celulares') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Informática') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Cama, Mesa e Banho') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Música') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Beleza e Perfumaria') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Livros') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Eletrônicos') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Esportes') ON CONFLICT (nome) DO NOTHING;
INSERT INTO produto_categoria (nome) VALUES ('Viagens') ON CONFLICT (nome) DO NOTHING;

INSERT INTO status (nome) VALUES ('Inicial') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Em análise') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Em aprovação') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Aprovado') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Em produção') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Pronto para entrega') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Em rota') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Em devolução') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Entregue') ON CONFLICT (nome) DO NOTHING;
INSERT INTO status (nome) VALUES ('Cancelado') ON CONFLICT (nome) DO NOTHING;
